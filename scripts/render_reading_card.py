...
<style>
/* Reading choices are horizontal lanes: category at left, items flowing right. */
.action-grid{{display:grid;grid-template-columns:1fr;gap:18px}}
.action-col{{display:grid;grid-template-columns:150px;grid-auto-flow:column;grid-auto-columns:minmax(220px,1fr);align-items:stretch;gap:12px;padding:16px;overflow-x:auto}}
.action-col h3{{margin:0;padding:12px 8px;align-self:start;white-space:nowrap}}
